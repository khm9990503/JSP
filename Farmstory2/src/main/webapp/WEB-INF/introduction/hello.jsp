...
<jsp:include page="/WEB-INF/_header.jsp"/>
        <div id="sub">
            <div>
                <img src="/Farmstory2/img/sub_top_tit1.png" alt="intro">
            </div>
            <section class="cate1">
                <aside>
                    <img src="/Farmstory2/img/sub_aside_cate1_tit.png" alt="소개">
                    <ul class="lnb">
                        <li class="on">
                            <a href="./hello.do"></a>
                        </li>
                        <li>
                            <a href="./direction.do"></a>
                        </li>
                    </ul>
                </aside>
                <article>
                    ...
                    <div class="helloContent">
                        <img src="/Farmstory2/img/sub_page1_article_txt.png" alt="건강한">
                        <p>
                        항상 저희 팜스토리를 성원해 주시고 관심을 가져주시는 모든 분들께 감사의 인사를 드리며<br>
                        가정에 건강과 행복이 가득하시길 기원합니다.<br>
                        <br>
                        팜스토리는 신선하고 안전한 먹거리로 건강한 삶 만들기에 기여합니다.<br>
                        보다 좋은 농산품을 공급하기 위해 화학비료를 쓰지 않는 건강한 흙에서 유기농업으로 정성을 다해 지은 농사를 통해 믿고 먹을 수 있는 먹거리 제공에 앞장서겠습니다.<br>
                        <br>
